...
export default definePlugin({
    ...
    patches: [
        ...
        // The profile popout of our mention contains another slate editor whose events propagate
        // through the react tree into the chatbox editor, ignore events that came from outside it
        {
